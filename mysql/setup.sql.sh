#!/bin/sh
export DATABASE=gyulek
export DBUSER=gyulek
export DBPASSWORD=gyulek123
export DBPREFIX=
export DEFCATALOG=gyülekezet
...
DROP TABLE IF EXISTS \`${DBPREFIX}amounts\`;
CREATE TABLE \`${DBPREFIX}amounts\` (
...
DROP TABLE IF EXISTS \`${DBPREFIX}diary\`;
CREATE TABLE \`${DBPREFIX}diary\` (
...
DROP TABLE IF EXISTS \`${DBPREFIX}hely_freetagged_objects\`;
CREATE TABLE \`${DBPREFIX}hely_freetagged_objects\` (
...
DROP TABLE IF EXISTS \`${DBPREFIX}hely_freetags\`;
CREATE TABLE \`${DBPREFIX}hely_freetags\` (
  \`id\` int(10) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS \`${DBPREFIX}lelkesz_freetagged_objects\`;
CREATE TABLE \`${DBPREFIX}lelkesz_freetagged_objects\` (
  \`tag_id\` int(10) unsigned NOT NULL default '0',
  \`tagger_id\` int(10) unsigned NOT NULL default '0',
  \`object_id\` int(10) unsigned NOT NULL default '0',
  \`tagged_on\` datetime NOT NULL default '0000-00-00 00:00:00',
...
DROP TABLE IF EXISTS \`${DBPREFIX}lelkesz_freetags\`;
CREATE TABLE \`${DBPREFIX}lelkesz_freetags\` (
  \`id\` int(10) unsigned NOT NULL auto_increment,
  \`tag\` varchar(30) NOT NULL default '',
  \`raw_tag\` varchar(50) NOT NULL default '',
  PRIMARY KEY  (\`id\`)
...
DROP TABLE IF EXISTS \`${DBPREFIX}members\`;
...
DROP TABLE IF EXISTS \`${DBPREFIX}religions\`;
CREATE TABLE \`${DBPREFIX}religions\` (
  \`id\` int(11) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS \`${DBPREFIX}status\`;
...
DROP TABLE IF EXISTS \`${DBPREFIX}szolgalat_freetagged_objects\`;
CREATE TABLE \`${DBPREFIX}szolgalat_freetagged_objects\` (
  \`tag_id\` int(10) unsigned NOT NULL default '0',
  \`tagger_id\` int(10) unsigned NOT NULL default '0',
  \`object_id\` int(10) unsigned NOT NULL default '0',
  \`tagged_on\` datetime NOT NULL default '0000-00-00 00:00:00',
...
DROP TABLE IF EXISTS \`${DBPREFIX}szolgalat_freetags\`;
CREATE TABLE \`${DBPREFIX}szolgalat_freetags\` (
  \`id\` int(10) unsigned NOT NULL auto_increment,
  \`tag\` varchar(30) NOT NULL default '',
  \`raw_tag\` varchar(50) NOT NULL default '',
  PRIMARY KEY  (\`id\`)
...
DROP TABLE IF EXISTS \`${DBPREFIX}tipus_freetagged_objects\`;
CREATE TABLE \`${DBPREFIX}tipus_freetagged_objects\` (
  \`tag_id\` int(10) unsigned NOT NULL default '0',
  \`tagger_id\` int(10) unsigned NOT NULL default '0',
  \`object_id\` int(10) unsigned NOT NULL default '0',
  \`tagged_on\` datetime NOT NULL default '0000-00-00 00:00:00',
...
DROP TABLE IF EXISTS \`${DBPREFIX}tipus_freetags\`;
CREATE TABLE \`${DBPREFIX}tipus_freetags\` (
  \`id\` int(10) unsigned NOT NULL auto_increment,
  \`tag\` varchar(30) NOT NULL default '',
  \`raw_tag\` varchar(50) NOT NULL default '',
  PRIMARY KEY  (\`id\`)
...
DROP TABLE IF EXISTS \`${DBPREFIX}member_freetagged_objects\`;
CREATE TABLE \`${DBPREFIX}member_freetagged_objects\` (
  \`tag_id\` int(10) unsigned NOT NULL default '0',
  \`tagger_id\` int(10) unsigned NOT NULL default '0',
  \`object_id\` int(10) unsigned NOT NULL default '0',
  \`tagged_on\` datetime NOT NULL default '0000-00-00 00:00:00',
...
DROP TABLE IF EXISTS \`${DBPREFIX}member_freetags\`;
CREATE TABLE \`${DBPREFIX}member_freetags\` (
  \`id\` int(10) unsigned NOT NULL auto_increment,
  \`tag\` varchar(30) NOT NULL default '',
  \`raw_tag\` varchar(50) NOT NULL default '',
  PRIMARY KEY  (\`id\`)
...
GRANT SELECT,INSERT,DELETE,UPDATE ON ${DATABASE}.* TO ${DBUSER}@localhost IDENTIFIED BY '${DBPASSWORD}';
INSERT INTO ${DBPREFIX}catalog (catalog_name,member_id) VALUES ('${DEFCATALOG}',0);
